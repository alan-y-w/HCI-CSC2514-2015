 ...
 */
public class CustomPatternLock extends View {
     ...
     */
    private static final int MILLIS_PER_CIRCLE_ANIMATING = 300;
    ...
    public CustomPatternLock(Context context) {
        this(context, null);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomPatternLock(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mRegularColor = getResources().getColor(R.color.colorPrimary);
//                getResources().getColor(
//                ResourceUtils.resolveAttribute(getContext(),
//                        R.attr.alp_42447968_color_lock_pattern_view_regular));
        mErrorColor = getResources().getColor(R.color.colorPrimary);
//                getResources().getColor(
//                ResourceUtils.resolveAttribute(getContext(),
//                        R.attr.alp_42447968_color_lock_pattern_view_error));
        mSuccessColor = getResources().getColor(R.color.colorPrimary);
//                getResources().getColor(
//                ResourceUtils.resolveAttribute(getContext(),
//                        R.attr.alp_42447968_color_lock_pattern_view_success));
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link CustomPatternLock#onSaveInstanceState()}
         */
